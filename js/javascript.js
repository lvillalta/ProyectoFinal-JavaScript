...
//BASE DE DATOS
	var productos = ["Portatil DELL", "Portatil ASUS", "Portatil HP", "Escritorio 1", "Escritorio 2", "Escritorio 3","Huawei","Samsung","Iphone", "Audifonos", "Protector celular", "Smartwatch"];
	var imgGrandes = ["img/productos/1.jpg", "img/productos/2.jpg", "img/productos/3.jpg", "img/productos/4.jpg", "img/productos/5.jpg", "img/productos/6.jpg", "img/productos/7.jpg", "img/productos/8.jpg", "img/productos/9.jpg","img/productos/10.jpg","img/productos/11.jpg","img/productos/12.jpg"];
	var imgPeque = ["img/productos/1m.jpg", "img/productos/2m.jpg", "img/productos/3m.jpg", "img/productos/4m.jpg", "img/productos/5m.jpg", "img/productos/6m.jpg", "img/productos/7m.jpg", "img/productos/8m.jpg", "img/productos/9m.jpg", "img/productos/10m.jpg", "img/productos/11m.jpg", "img/productos/12m.jpg"];
	var precios = [33, 169, 36, 360, 11, 540, 21, 66, 25,20,30,50];
	var stock = [5, 2, 8, 3, 10, 4, 3, 1, 2, 2, 3, 4];
...
function cambiarColor(opcion,url) {
		//console.log(opcion);
		//console.log(url);
